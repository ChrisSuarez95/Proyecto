...
class Maestros extends Component {
  ...
  addMaestro = (event) => {
    ...
    const data = {
      ...
      nombreDoc: this.frmNombreDoc.value,
    };
  ...
  editMaestro = (id, row) => (event) => {
    ...
    this.frmNombreDoc.focus();
    this.frmNombreDoc.value = this.state.maestros1[row].nombreDoc;
  };
        ...
        >
          {this.state.maestros1.map((maestro, index) => (
            <ListItem button key={index}>
              ...
              <ListItemText inset primary={maestro.noControl} />
              <ListItemText inset primary={maestro.nombre} />
